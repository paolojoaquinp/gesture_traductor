...
class PeaceRepositoryImpl implements GestureRepository {
  List<Offset> points;
  double ratio;
  PeaceRepositoryImpl({
  ...
  String getGestureDescription() {
    return 'esta es una descripcion de un gesto de paz';
  }
