...
class PointingUpRepositoryImpl implements GestureRepository {
  List<Offset> points;
  double ratio;
  PointingUpRepositoryImpl({
  ...
  String getGestureDescription() {
    return 'esta es la descripcion del dedo indice apuntando arriba';
  }
  ...
  bool middleFingerVerify() {
    ...
    final p4 = sublist[3];
    final p5 = sublist[4];
    final angle1 = utils.angle(p1, p2, p4);
