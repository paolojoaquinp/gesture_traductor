...
class ThumbUpRepositoryImpl implements GestureRepository {
  List<Offset> points;
  double ratio;
  ThumbUpRepositoryImpl({
  ...
  String getGestureDescription() {
    return 'Esta es la descripcion de un pulgar arriba';
  }

  @override
  String getGestureName() {
    return 'Pulgar arriba(Thumb Up)';
  }
